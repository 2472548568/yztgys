...
```bash
# 使用渲染脚本
$CODEX_HOME/skills/diagram-generator/scripts/render-diagram.sh <源文件.xml> <输出.png>
...
3. 以模板为骨架替换为实际业务内容
4. 保存 XML 源文件到 `交付物/图表/系统名称/src/`
5. 渲染为 PNG 保存到 `交付物/图表/系统名称/`
6. 在文档中插入 `![描述](交付物/图表/系统名称/文件名.png)`
